...
<head>
    ...
    <script type="text/javascript">
	    ...
	    var timer = setInterval( updateDiv2, 1000);
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">In?cio</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#portfolio">Bot?es</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Manipulacao de pinos da Raspberry Pi!!</h1>
                <hr>
                <p>Esse site e um prototipo de como podemos manipular os pinos da raspberry e tambem receber informacoes de sensores!</p>
                <a href="#about" class="btn btn-primary btn-xl page-scroll">Fazer teste!</a>
            </div>
        </div>
    </header>
    ...
    <section class="bg-dark" id="portfolio">
	  <div class="container">
            <div class="row text-center">
                 <h2 class="section-heading">Controle das GPIOs</h2>
                    <hr class="primary">
    ...
    <aside class="bg-primary">
        <div class="container text-center">
            <div class="call-to-action">
                <h2>Faca o download no Github</h2>
                <a href="http://github.com/arturgoms/Spectro-Project" class="btn btn-default btn-xl sr-button">Download!</a>
            </div>
        </div>
    </aside>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-center">
                    <i class="fa fa-envelope-o fa-3x sr-contact text-center"></i>
